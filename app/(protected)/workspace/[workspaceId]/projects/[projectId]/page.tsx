import { getProjectDetails } from '@/app/data/project/get-projectDetails';
      ...
      className='w-full'>
        <TabsList className='mb-4'>
          <Link href="?view=dashboard">
            <TabsTrigger
            value='dashboard' className='px-1.5 md:px-3'
            >
              Dashboard
            </TabsTrigger>
          </Link>
          <Link href="?view=table">
            <TabsTrigger
            value='table' className='px-1.5 md:px-3'
            >
              Table
            </TabsTrigger>
          </Link>
          <Link href="?view=kanban">
            <TabsTrigger
            value='kanban' className='px-1.5 md:px-3'
            >
              Kanban
            </TabsTrigger>
          </Link>
